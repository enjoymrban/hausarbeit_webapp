    ...
    $.ajax({
        ...
        context.render('/assets/html/learnnow.html', {})
            ...
            .then(function () {
                ...
                var box = $('<div class="col-xl-3 col-md-4 col-sm-6   "><div class="card card-box align-items-center "><img id="boxchangestate'+0+'" class="card-img-top" src="/assets//images/box_closed.png" alt="Karteikarte"><div class="card-img-overlay"><a href="#/createbox"><div class="card-body card-body-box"><img src="/assets//images/icons/add.svg" alt="addBox"  width="80" height="80" /></div></a></div></div></div>')
                $(".box" ).append(box);
            })
    });
